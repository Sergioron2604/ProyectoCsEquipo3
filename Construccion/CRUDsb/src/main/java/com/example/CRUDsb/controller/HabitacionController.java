...
public class HabitacionController {
    ...
    public ResponseEntity<Double> getPrecioById(@PathVariable("id_habitacion") Long habitacionId) {
        Optional<Double> precio = habitacionService.obtenerPrecioPorId(habitacionId);
